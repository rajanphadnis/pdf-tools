...
function showPDF(pdfDataUri) {
  document.getElementById("iframe_preview").innerHTML = "<iframe src='" + pdfDataUri + "'></iframe>";
//   document.getElementById("pdf-viewport").contentWindow.location.reload();
  console.log("done");
}
